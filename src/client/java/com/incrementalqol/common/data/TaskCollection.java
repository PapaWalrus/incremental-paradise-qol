...
public class TaskCollection {
	...
	static {
        ...
        TaskDescriptors.put(TaskTarget.WildBoar, new TaskDescriptor(TaskType.Combat, "hoglin", new ArrayList<>(List.of("w1")), TaskType.Combat, ToolType.Melee));
        ...
        TaskDescriptors.put(TaskTarget.Hoglin, new TaskDescriptor(TaskType.Boss, "hoglin", new ArrayList<>(List.of("carrot")), TaskType.Boss, ToolType.Melee));
        ...
        TaskDescriptors.put(TaskTarget.Bonsai, new TaskDescriptor(TaskType.Foraging, "sky", new ArrayList<>(List.of("w2")), TaskType.Foraging, ToolType.Axe));
        TaskDescriptors.put(TaskTarget.Pomegranate, new TaskDescriptor(TaskType.Foraging, "sky", new ArrayList<>(List.of("w2")), TaskType.Foraging, ToolType.Axe));
        ...
        TaskDescriptors.put(TaskTarget.SkyBeetle, new TaskDescriptor(TaskType.Foraging, "sky", new ArrayList<>(List.of("w2")), TaskType.Foraging, ToolType.Axe));
        ...
        TaskDescriptors.put(TaskTarget.Rodrick, new TaskDescriptor(TaskType.Boss, "rodrick", new ArrayList<>(List.of("garlic")), TaskType.Boss, ToolType.Melee));
        TaskDescriptors.put(TaskTarget.SkyBeetleQueen, new TaskDescriptor(TaskType.Boss, "sky", new ArrayList<>(List.of("shimmer")), TaskType.Boss, ToolType.Bow));
        ...
        TaskDescriptors.put(TaskTarget.Capsnapper, new TaskDescriptor(TaskType.Foraging, "beach", new ArrayList<>(List.of("w3")), TaskType.Foraging, ToolType.Axe));
        ...
        TaskDescriptors.put(TaskTarget.Oinky, new TaskDescriptor(TaskType.DreamFarming, "sty", new ArrayList<>(List.of("w3")), TaskType.DreamFarming, ToolType.Hoe));
        TaskDescriptors.put(TaskTarget.Cattail, new TaskDescriptor(TaskType.DreamFarming, "beach", new ArrayList<>(List.of("w3")), TaskType.DreamFarming, ToolType.Hoe));
        TaskDescriptors.put(TaskTarget.Gloom, new TaskDescriptor(TaskType.DreamFarming, "underside", new ArrayList<>(List.of("w3")), TaskType.DreamFarming, ToolType.Hoe));
        TaskDescriptors.put(TaskTarget.CollieFlower, new TaskDescriptor(TaskType.DreamFarming, "canine", new ArrayList<>(List.of("w3")), TaskType.DreamFarming, ToolType.Hoe));
        ...
        TaskDescriptors.put(TaskTarget.Shiver_Money, new TaskDescriptor(TaskType.Mining, "netherite", new ArrayList<>(List.of("netherite", "lapis", "quartz", "n1")), TaskType.Mining, ToolType.Pickaxe));
    }
	...
	static {
        ...
        TaskMap.put("fish", TaskTarget.Soarfish);
	...
	public static class TaskDescriptor {
		...
		public TaskDescriptor(TaskType type, String command, ArrayList<String> fallbackCommands, TaskType wardrobe,
				ToolType hotBarSlotId) {
			this.type = type;
